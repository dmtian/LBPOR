/*
SHAKE implementation. The code comes from [Falcon18].

[Falcon]Fouque, P.A., Hoffstein, J., Kirchner, P., Lyubashevsky, V., Pornin, T., Prest, T., Ricosset, *T., Seiler, G., Whyte, W., Zhang, Z.: Falcon: Fast-fourier latticebased compact signatures *over ntru (2018), submission to NIST Post-Quantum Competition
 */
